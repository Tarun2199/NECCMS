   ...
   <body>
      ...
      <!-- content -->
         <div class="bg-light lter b-b wrapper-md">
            <h1 class="m-n font-thin h3">PickUps and Deliveries</h1>
         </div>
...
String sql = "select * from booking where status = ? and( sender_agent = ? or receiver_agent=?);";
  ...
  <div class="panel-body">
   <% if (count!=0) {%>
               ...
               <th>Status</th>
                      ...
                      <% sender_agent = rs.getString("sender_agent");
                        	if (sender_agent.equals(username)==true)
                        		{%>
                        <td><%=rs.getString("sender_name")%></td>
                        <td><%=rs.getString("sender_address")%></td>
                        <td><%=rs.getString("sender_city")%></td>
                        <td><%=rs.getString("sender_phone")%></td>
                        <td>Pickup</td>
                        <td>Picked Up</td>
                      </tr>
                      <%}
                    ...
                    {
                    %>
                    <h1>You have not done any work yet!!</h1>
                    <%}
   rs.close();
   ps.close();
   con.close();
