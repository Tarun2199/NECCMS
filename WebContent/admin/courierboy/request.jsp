...
<html lang="en" class="">
  ...
  margin-left: 300px;
   ...
   <body>
      ...
      <div class="bg-light lter b-b wrapper-md">
            <h1 class="m-n font-thin h3">Reschedule or cancel</h1>
         </div>
      <div class="ex1">
  ...
  <div class="panel-body">
                      ...
                      <br>
                      <br>
   <label class="radio-inline"><input type="radio" value="a">Re-schedule</label>
<label class="radio-inline"><input type="radio" value="a">Cancel</label>
