...
<html lang="en" class="">
   ...
   if(session.getAttribute("username")==null)
      ...
      <%! String username;
	   ...
	   String sql1 = "select COUNT(*) from booking where sender_agent=? or receiver_agent=?";
	   String sql2 = "select Count(*) from booking where sender_agent=? and status =?";
	   String sql3 = "select Count(*) from booking where receiver_agent=? and status=?";
	   String sql4 = "select Count(*) from booking where sender_agent=? and (status =? or status=? or status=?)";
	   // System.out.println(username);
	   int total=0,del_req=0,pickup_hist=0,pickup_req=0;
		   ...
		   ps.setString(1,username);
		   ps.setString(2,"assignedforpickup");
		   rs = ps.executeQuery();
		   while(rs.next()){
			   pickup_req=rs.getInt(1);
		   }
		 ps = con.prepareStatement(sql3);
	   ps.setString(1,username);
	   ps.setString(2,"assignedfordelivery");
	   rs = ps.executeQuery();
	   while(rs.next()){
		   del_req=rs.getInt(1);
	   }
	   ...
	   ps.setString(1,username);
	   ps.setString(2,"intransit");
	   ps.setString(3,"assignedfordelivery");
	   ps.setString(4,"delivered");
	   rs = ps.executeQuery();
	   while(rs.next()){
		   pickup_hist=rs.getInt(1);
	   }
                  ...
                  <ul class="nav">
                     ...
                     <li >
                        ...
                        <ul class="nav nav-sub dk">
                           ...
                           <li >
                              <a href="request.jsp">
                              <span>Request re-schedule or cancellation</span>
                              </a>
                           </li>
                        </ul>
                     </li>
      ...
      <div class="hbox hbox-auto-xs hbox-auto-sm">
         ...
         <div class="wrapper-md">
            <div class="col">
               <div class="row">
                  <div class="col-lg-12" id="section_tile">
                     <div class="row row-sm text-center">
                        ...
                        <div class="col-xs-6" id="section_tile2">
                           <div class="panel padder-v item bg-primary">
                              <div class="text-white font-thin h1 block1" id="sales_total"> <% out.println(del_req); %></div>
                        ...
                        <div class="col-xs-6" id="section_tile4">
                           <div class="panel padder-v item">
                              <div class="font-thin text-info h1" id="mail_total"><% out.println(pickup_req); %></div>
