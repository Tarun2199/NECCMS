  ...
  <head>
   ...
   if(session.getAttribute("username")==null)
                  ...
                  <div class="dropdown-menu w-xl animated fadeInUp">
                     <div class="panel bg-white">
                        <div class="panel-heading b-light bg-light">
                           <strong>You have no new mail</strong>
                        </div>
                  ...
                  <ul class="nav">
                    ...
                    <li >
                        ...
                        <ul class="nav nav-sub dk">
                           ...
                           <li >
                              <a href="request.jsp">
                                <span>Create re-scheduling or cancellation</span>
                              </a>
                           </li>
                        </ul>
                     </li>
     ...
     <% 		
     			...
     			con = details.getConn();
     			DatabaseCon details2 = new DatabaseCon();
     			con2 = details2.getConn();
                 PreparedStatement ps = null;
                 PreparedStatement ps2 = null;
                 ResultSet rs = null;
                 ResultSet rs2 = null;
                 String username=(String)session.getAttribute("username");
                 String sql1 = "select * from booking where receiver_agent=? and status=?";
                 String sql2 = "select * from booking where sender_agent=? and status=?";
                 int c=0,d=0;
                 try{
                	 int b_id=-1,b_id2=0;
                   ...
                   ps2.setString(2,"assignedforpickup");
           ...
           <table class="table table-striped table-hover" width=400>
              ...
              <tbody id="myTable">
                        <tr>
                          ...
                          <!-- Modal body -->
                                  <form action="checkotp.jsp?id=<%=b_id %>" method="post" >
                       ...
                       <%} } 
                        ...
                        while(rs2.next()) { %>
                        <tr>
                          <td><%= b_id2=rs2.getInt("booking_id")%>     
                           </td>
                           
                          <td><%=rs2.getString("sender_name")%></td>
                          <td><%=rs2.getString("sender_address")%></td>
                          <td><%=rs2.getString("sender_city")%></td>
                          <td><%=rs2.getString("sender_phone")%></td>
                          <td><%=rs2.getString("status")%></td>
                          <td>
                            <form action="update.jsp?id=<%=b_id2 %>" method="post" >
                             <input type="submit" value="Update Status"  class="btn btn-danger"  >
                            </form>
                       	  </td>
                       	 </tr>
                       	  <%}} %>
