         ...
         <div class="app-content-body ">
            <div class="hbox hbox-auto-xs hbox-auto-sm">
               ...
               <div class="bg-light lter b-b wrapper-md">
                  <h1 class="m-n font-thin h3">Sub-admins</h1>
               </div>
               <!-- / main header -->
                        ...
                        <div class="ex1">
                          ...
                          <table class="table table-striped table-hover" width=400>
                           <thead> 
                              ...
                              <th class="text-center">Sender Admin</th>
                              <th class="text-center">Reciver Admin</th>
                      	  ...
                      	  Connection conn = details.getConn();
                               ...
                               while(rs.next())
                               {
                                 ...
                                 <tr>
                                   ...
                                   <td><%=rs.getString("sender_admin") %></td>
                                   <td><%=rs.getString("receiver_admin") %></td>
