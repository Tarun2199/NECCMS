    ...
    <div class="m-b-lg">
        ...
        <div class="list-group form-group">
            <div class="list-group-item">
                <input name="firstname" id="first_name" autocomplete="Off" size="32" maxlength="128" placeholder="First Name" class="form-control no-border" type="text">
            </div>
            <div class="list-group-item form-group">
                <input name="lastname" id="last_name" size="32" maxlength="32" placeholder="Last Name" class="form-control no-border password" type="text">
            </div>
			<div class="list-group-item">
        ...
        <div class="m-t-xxl">
            <input id="admin_login" name="submit" value="Sign Up" class="btn btn-lg btn-default btn-block" type="submit"><span id="loginmsg" style="display:none"></span>
        </div>
        </form>
